using APIIntegrationTests.TestData;
...
//https://github.com/CodeMazeBlog/testing-aspnetcore-mvc/blob/integration-testing-mvc/EmployeesApp/EmployeesApp.IntegrationTests/TestingWebAppFactory.cs
            ...
            builder.ConfigureServices(services =>
            {
                ...
                using (var appContext = scope.ServiceProvider.GetRequiredService<ApplicationDbContext>())
                {
                    try
                    {
                        ...
                        AddTestData.AddSingleMovieData(appContext);
